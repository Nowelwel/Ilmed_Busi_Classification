...
def build_train_transform(cfg_data: DataConfig, cfg_aug: AugmentationConfig) -> transforms.Compose:
    ...
    return transforms.Compose([
        ...
        transforms.RandomAffine(
            degrees=0,                               # Rotasi sudah ditangani di atas
        ...
        transforms.ColorJitter(
            ...
            saturation=0.0,                          # Tidak relevan untuk grayscale→RGB
            hue=0.0,
        ),
        transforms.ToTensor(),
...
def split_dataset(
    ...
    # val_size adalah proporsi dari total, sehingga perlu disesuaikan
...
def build_dataloaders(
    ...
    Tidak menggunakan WeightedRandomSampler karena imbalance
    ditangani langsung oleh Focal Loss (α=0.9, γ=2).
    ...
    train_loader = DataLoader(
        ...
        shuffle=True,                 # Shuffle training, tanpa sampler
